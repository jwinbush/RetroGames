...
<head>
    <meta charset="UTF-8">
    <!--Font Awesome Link-->
    <script src="https://kit.fontawesome.com/4ffbb4afc2.js" crossorigin="anonymous"></script>    
        ...
        <header style=" box-shadow: 0 10px 8px 0 rgba(0, 0, 0, 0.2);" class="header">
            ...
            <div class="site-navigation">
                <ul class="site-navs">
                    ...
                    <!--Cart-->
                    <div class="dropdown" class="navs">
                        <li class="dropbtn"><a href="cart.php"><i class="fa-sharp fa-solid fa-cart-shopping"></i></a>
                            <?php
                                if(!empty($cartArray)) {
